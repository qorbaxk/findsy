...
export default function Contact() {
  return (
    <div className="p-4 md:p-16 h-screen pt-16 md:pt-16">
      <div className="opacity-0 animate-fade-in transition-opacity duration-700 bg-white/60 border-[1px] border-solid border-white/80 rounded-[11px] p-2 md:p-4 h-full flex flex-col relative overflow-hidden">
        {/* 하위 제목 */}
        <h2 className="text-2xl md:text-4xl border-b-[1px] border-b-solid text-center pb-2 font-Mediasansextended">
          Contact
        </h2>
        {/* 하단 소개 내용 */}
        <div className="px-4 md:px-[300px] py-8 md:py-16 z-10">
