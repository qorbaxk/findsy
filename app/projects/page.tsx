    ...
    description={
      <div className="flex flex-col gap-4">
        ...
        <div className="bg-yellow-50 rounded-lg py-2 px-4 flex flex-col gap-1">
          ...
          <p className="text-md flex flex-col">
            <span>
              <b>단순히 일회성으로 사용되는 컴포넌트가 아닌, 여러 프로젝트에 재사용될 핵심 자산</b>을 만드는 일이었기에 초기 설계에 많은 고민이 필요했습니다.
              <br /><br />
              먼저, <b>스타일 도구의 기준을 정하기 위해</b> 프로젝트 참여자뿐만 아니라 회사 내 전체 프론트엔드 개발자들과 회의를 진행했습니다. 여러 의견을 조율한 끝에 <b>TailwindCSS를 스타일 도구로 채택</b>하였으며, 이 결정은 <b>유지보수성과 직관성을 중시한 결과</b>였습니다.
              <br /><br />
              입력값이 많은 관리도구의 특성상 <b>유효성 검증을 체계적으로 처리할 수 있는 라이브러리</b>가 필요했고, 이에 따라 <b>React-Hook-Form을 도입</b>했습니다. 해당 라이브러리를 처음 접한 팀원들이 많았기 때문에, <b>내부 문서화와 주석 작성에 공을 들여 누구나 쉽게 이해하고 사용할 수 있도록 정리</b>하였습니다.
              <br /><br />
              개발 초기에는 컴포넌트 자체 구현보다도, <b>이후 개발자들이 쉽게 활용할 수 있도록 문서화하고 유지보수 체계를 만드는 것이 가장 큰 과제</b>였습니다. 이를 위해 <b>Storybook을 도입</b>해 모든 컴포넌트를 시각적으로 정리하고 배포했으며, 이후 <b>실제 사용 시 불편했던 부분들을 스스로 찾아 개선하고 리팩토링</b>을 반복했습니다.
              <br /><br />
              프로젝트 종료 이후에도 팀원 이탈로 인한 유지보수 공백이 생기자, 회사의 지시 없이도 <b>공통 컴포넌트를 사용하는 다른 프로젝트들에서 발견한 문제들을 자발적으로 개선</b>하며 품질을 지속적으로 향상시켰습니다.
            </span>
          </p>
        </div>
        ...
        <div className="bg-yellow-50 rounded-lg py-2 px-4 flex flex-col gap-1">
          ...
          <p className="text-md flex flex-col">
            <span>
              해당 프로젝트를 통해 <b>여러 실무 프로젝트에서 즉시 활용 가능한 컴포넌트 자산</b>을 마련함으로써, <b>개발 초기 단계의 시간과 리소스를 크게 절감</b>할 수 있었습니다.
              <br /><br />
              실제로 공통 컴포넌트를 활용한 프로젝트들은 <b>전체 개발 기간을 약 30% 이상 단축</b>할 수 있었고, <b>UI 일관성 및 유지보수 효율성 측면에서도 큰 효과</b>를 거둘 수 있었습니다.
              <br /><br />
              프로젝트 종료 이후에도 다양한 개발자들이 <b>직접 복사하여 사용할 만큼 활용도가 높았고</b>, <b>“잘 만들어졌다”, “정리가 잘 되어 있어 이해하기 쉽다”</b>는 긍정적인 피드백을 꾸준히 받을 수 있었습니다.
              <br /><br />
              다만 아쉬운 점은 <b>라이브러리로 완전히 패키징하여 배포하지 못한 것</b>이었지만, 그럼에도 사내 여러 프로젝트에서 <b>사실상의 표준 UI로 자리 잡게 되었고</b>, 회사 차원에서도 <b>개발 생산성 향상 기여도를 인정받아 연봉 인상</b>이라는 긍정적인 결과로 이어졌습니다.
            </span>
          </p>
        </div>
      </div>
